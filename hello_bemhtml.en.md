...
Organize the development cycle (edit - compile - view - edit ...) helps bem server.
You need to run it in the root folder of the project:

````js
    $ ./node_modules/.bin/bem server
````
The server listens at (http://localhost:8080/), and assembles pages on request from the browser, such as
...
Create a blank page layout (call it test):
...
Look at result. Fragment of HTML-code that describes the body of the page looks like this:
